...
def run_alexa():
    ...
    try:
        ...
        elif 'who is mavullamma madam in sita polytechnic' in command:
            print('Mavullamma madam is one of the best faculty in smt b seetha polytechnic. She is the favourite teacher for all the students')
            engine_talk('Mavullamma madam is one of the best faculty in smt b seetha polytechnic. She is the favourite teacher for all the students')
        elif 'who is Srinu sir in polytecnic' in command:
            print('Srinu sir is one of the best faculty in smt b seetha polytechnic. He is the favourite teacher for all the students')
            engine_talk('sreenu sir is one of the best faculty in smt b seetha polytechnic. He is the favourite teacher for all the students')
        elif 'who ia ramesh sir' in command:
            print('ramesh sir is one of the best faculty in smt b seetha polytechnic. She is the favourite teacher for all the students')
            engine_talk('ramesh sir is one of the best faculty in smt b seetha polytechnic. She is the favourite teacher for all the students')
